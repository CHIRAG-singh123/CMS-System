...
const base = [
  ...
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-zinc-500 dark:group-data-focus:outline-zinc-400',
  // Disabled state
